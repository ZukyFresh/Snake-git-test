import random
import tkinter
canvas=tkinter.Canvas(width=700,height=700,bg="lightskyblue")
canvas.pack()
def had():
    global x,x2,y,y2
...
def nahoru(sour):
    ...
    if av==1:
        ...
        p3=0
        p4=0
#vytvařeni těch objektu je tam jen protože nevím jak napsat prázdnou funkci
def doleva(sour):
...
ax=1
kouskyhada=1
j=0#j a k jsou hodnoty nastavující směr hada
x=70
p1=1
p2=1
p3=1
...
x2=90
y2=80
h=5#hodnota ktera se přidává k souřadnicím y
h2=5#hodnota ktera se pridava k souradnicim x
had()
bod()
okraj()
pohybhada()
